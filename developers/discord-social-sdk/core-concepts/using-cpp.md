...
<Accordion title="Mac libdiscord_partner_sdk.dylib Not Opened">
  On Mac you may get the error "libdiscord\_partner\_sdk.dylib" Not Opened because Apple couldn't verify it. If this happens press **Done** on the popup.
    ...
    <img src="https://mintcdn.com/discord/eiEEruEfypjAPE6V/images/social-sdk/getting-started/partials/error.png?fit=max&auto=format&n=eiEEruEfypjAPE6V&q=85&s=ae75a07e2078764e2e8140230b5bbf31" alt="Error" width="542" height="544" data-path="images/social-sdk/getting-started/partials/error.png" />
  ...
  You'll need to open your **System Settings > Privacy & Security** and scroll down to the **Security** section. It will tell you "libdiscord\_partner\_sdk.dylib" was blocked to protect your Mac. Press **Open Anyway** and try running again.
    ...
    <img src="https://mintcdn.com/discord/eiEEruEfypjAPE6V/images/social-sdk/getting-started/partials/security-settings.png?fit=max&auto=format&n=eiEEruEfypjAPE6V&q=85&s=a9593d3ba30769a627971ecd3a2ef9b1" alt="Settings" width="958" height="370" data-path="images/social-sdk/getting-started/partials/security-settings.png" />

  Now when you get the pop up you'll have the option to select **Open Anyway** and it will be able to use it successfully.

    <img src="https://mintcdn.com/discord/eiEEruEfypjAPE6V/images/social-sdk/getting-started/partials/open-anyway.png?fit=max&auto=format&n=eiEEruEfypjAPE6V&q=85&s=2df379b1fd8e44475ac10065beb4eeb3" alt="Open" width="544" height="710" data-path="images/social-sdk/getting-started/partials/open-anyway.png" />
</Accordion>
