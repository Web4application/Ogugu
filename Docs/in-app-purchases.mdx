...
Before thinking about monetizing your application, [make sure it's already configured as an Embedded Application](../setting-up-your-discord-application.md#marking-your-application-as-embedded.html).
